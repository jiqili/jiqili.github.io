...
## 源码
本文抽取了Autodesk Viewer SDK的源码,并通过让AI分析项目源码,学习了一些性能优化的方法.
源码是闭源的,并使用Webpack打包,把源码用`eval`函数包起来,并把mapping文件进行base64编码.我把源码解析出来并按照目录组织好代码文件,只用于个人学习使用,未暴露给第三方组织或个人.
