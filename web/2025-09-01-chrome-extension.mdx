...
# 上线
花了5$注册了谷歌开发者账号，然后上传插件项目的zip包，需要写描述信息和权限申请的理由，还有隐私政策的url。隐私政策我用AI生成后放在一个public的git仓库里的Readme文件。每次修改都可以保存草稿，可以看到提交的草稿的状态，第一次提交的描述信息写的有些随便，被拒了，说有误导性或不真实信息。
